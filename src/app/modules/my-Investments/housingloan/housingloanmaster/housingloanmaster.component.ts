...
export class HousingloanmasterComponent implements OnInit {
 ...
 public policyMaxDatePPF: Date;
  ...
  public ngOnInit(): void {
   this.addOwner(0);
   // this.form.get('housePropertyLoanDetailList').get('purposeOfLoan').setValue('Acquisition or construction');
  ...
  public addLoanDetails() {
    console.log(this.form.get('housePropertyLoanDetailList').value);
    ...
    console.log('loanGrid', this.loanDetailGridData);
  ...
  // ------------------------------------Master----------------------------
    ...
    // Post Master Page Data API call
      public addMaster(formData: any, formDirective: FormGroupDirective): void {
        ...
        if (this.propertyIndex.length === 0 || this.propertyIndex.length === 0 ||
          this.propertyIndex.length === 0 || this.propertyIndex.length === 0 ) {
