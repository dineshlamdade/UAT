...
import { ChildeducationallowanceService } from '../../Child Education Allowance/childeducationallowance.service';
...
export class CeamasterComponent implements OnInit {
  ...
  getFamilyMemberInfo(){
    this.childeducationallowanceService.getFamilyInfo().subscribe((res) => {
  ...
  //----------- Family age shown on Policyholder selection ---------------
  OnSelectionfamilyMemberGroup() {
    const toSelect = this.familyMemberGroup.find(
      (c) => c.familyMemberName === this.form.get('policyholdername').value
    );
    this.form.get('familyMemberInfoId').setValue(toSelect.familyMemberInfoId);
    this.form.get('age').setValue(toSelect.relation);
  }
