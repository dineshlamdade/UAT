...
@Component({
  selector: 'app-ggc-declaration-actual',
  templateUrl: './ggc-declaration-actual.component.html',
...
export class GgcDeclarationActualComponent implements OnInit {
  ...
  public saveTransaction(formDirective: FormGroupDirective): void {
    ...
    this.ggcService
      .upload80GGCTransactionwithDocument(this.filesArray, data)
      .subscribe((res) => {
...
public docViewer1(template3: TemplateRef<any>, index: any, data: any) {
  ...
  public uploadUpdateTransaction() {
    ...
    this.ggcService
      .upload80GGCTransactionwithDocument(this.editfilesArray, data)
      .subscribe((res) => {
  ...
  removeSelectedTransactionDocumentInEditCase(index: number) {
    ...
    console.log('this.editfilesArray.size::', this.editfilesArray.length);
      ...
      getTransactionFilterData() {
        ...
        this.ggcService.getTransactionFilterData().subscribe((res) => {
