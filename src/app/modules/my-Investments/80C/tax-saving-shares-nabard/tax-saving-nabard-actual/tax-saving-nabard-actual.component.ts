...
export class TaxSavingNabardActualComponent implements OnInit {
  ...
  constructor(
    ...
    this.initiateTaxSavingNabardForm()
  ...
  public ngOnInit(): void {
    ...
    // Initiate Tax Saving Nabard Form
    initiateTaxSavingNabardForm(){
  ...
  submitDeclaration() {
    ...
    this.taxSavingNabardService.postTSNabardTransaction(data).subscribe((res) => {
      console.log(res);
      this.transactionDetail =
