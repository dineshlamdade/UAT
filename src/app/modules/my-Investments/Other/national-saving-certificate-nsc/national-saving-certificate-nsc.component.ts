...
export class NationalSavingCertificateNSCComponent implements OnInit {
  ...
  constructor( private nationalSavingCertificateNSCAccruedInterestService: NationalSavingCertificateNSCAccruedInterestService,
  ...
  ngOnInit() {
   ...
   // Summary get Call
   summaryPage() {
    this.nationalSavingCertificateNSCAccruedInterestService.getNSCAccrued().subscribe((res) => {
