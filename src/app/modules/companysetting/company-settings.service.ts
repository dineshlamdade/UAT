...
export class CompanySettingsService {
  url = environment.baseUrl8086;
  url1 = environment.baseUrl8084;
  constructor(private _HTTP: HttpClient) { }

  getAllPayrollheadAttributeMaster() {

    return this._HTTP.get(this.url1 + 'payrollhead-attribute-master')
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  //   return this._HTTP.get( this.url1 + 'payrollhead-attribute-master/getAllGlobalAttributeMaster' )
  //     .pipe( map( ( res: any ) => {
  //       return res;
  //     } ) );
  // }
  ...
  getAllGlobalAttributeMasterByGlobal() {
    return this._HTTP.get(this.url1 + 'attribute-group/global-getAll')
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  getAttributeGroup() {
    return this._HTTP.get(this.url1 + 'attribute-group')
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  getByHeadMasterByNature(earningordeduction: any) {
    return this._HTTP.get(this.url1 + 'attribute-group/globalHeadType/' + earningordeduction)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  getByHeadMasterByNatureByGroup(earningordeduction: any) {
    return this._HTTP.get(this.url1 + 'attribute-group/headType/' + earningordeduction)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  getAllGlobalAttributeCreation() {
    ...
    return this._HTTP.get(this.url1 + 'payrollhead-attribute-master/getAllActiveGlobalAttributeMaster')
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  GetAttributeCreationById(id: number) {
    return this._HTTP.get(this.url1 + 'payrollhead-attribute-master/getAttMaster/' + id)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  AddAttributeCreation(data: SaveAttributeCreation): Observable<number | {}> {
    ...
    return this._HTTP.post(this.url1 + 'payrollhead-attribute-master', data)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  UpdateAttributeCreation(data: SaveAttributeCreation) {
    ...
    return this._HTTP.put(this.url1 + 'payrollhead-attribute-master', data)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  GetAttriubuteSelectionByIdGlobal(id: number) {
    ...
    return this._HTTP.get(this.url1 + 'attribute-group/globalAttGroupById/' + id)
      .pipe(map((res: any) => {
        return res;
      }));
  ...
  GetAttributeSelectionById(id: number) {//: Observable<saveBusinessYear | {}> {
    ...
    return this._HTTP.get(this.url1 + 'attribute-group/global/' + id)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  UpdateAttributeGlobal(id: number, data: SaveAttributeSelection): Observable<number | {}> {
    return this._HTTP.put(this.url1 + 'attribute-group/updateAttGroupDefById/' + id, data)
      .pipe(map((res: any) => {
        return res;
      }));
  ...
  UpdateAttributeGroup(id: number, data: SaveAttributeSelection): Observable<number | {}> {
    ...
    return this._HTTP.put(this.url1 + 'attribute-group/updateById/' + id, data)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  GetAttributeOptionListByGlobal(phgName: string) {
    ...
    return this._HTTP.get(this.url1 + 'headGroup/getGlobalPHGByName/' + phgName)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  getHeadMasterGroupByPHG_GroupDefId(headGroupDefId: any) {
    return this._HTTP.get(this.url1 + 'headGroup/getGlobalPHGById/' + headGroupDefId)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  GetAttributeOptionListByGroup(groupname: string) {
    ...
    return this._HTTP.get(this.url1 + 'attribute-group/getGroupByName/' + groupname)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  AddAttributeSelectionGlobal(data: SaveAttributeSelection): Observable<number | {}> {
    ...
    return this._HTTP.post(this.url1 + 'attribute-group/global-add', data)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  AddAttributeSelection(data: SaveAttributeSelection): Observable<number | {}> {
    ...
    return this._HTTP.post(this.url1 + 'attribute-group', data)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  DeleteAttributeSelectionAtGlobal(id: number) {
    return this._HTTP.delete(this.url1 + 'attribute-group/globalDelete/' + id)
      .pipe(map((res: any) => {
        return res;
      }));
  ...
  DeleteAttributeSelection(id: number) {
    return this._HTTP.delete(this.url1 + 'attribute-group/delete/' + id)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  postPayrollHeadAttributeMappingAddGlobal(data: any) {
    return this._HTTP.post(this.url1 + 'payrollhead-attribute-mapping/addGlobal', data)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  putPayrollHeadAttributeMappingAddGlobal(data: any) {
    return this._HTTP.put(this.url1 + 'payrollhead-attribute-mapping/updateGlobal', data)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  getAllPayRollHeadGroupAttributeHistory(headGroupId: number, AttributeGroupId: number) {
    ...
    return this._HTTP.get(this.url1 + 'payrollhead-attribute-mapping/getAllPayRollHeadGroupAttributeHistory/' + headGroupId + '/' + AttributeGroupId)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  // }
    ...
    return this._HTTP.get(environment.baseUrl8086 + 'business-cycle/getBusinessSummaryData/')
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  viewCycleCreation(data): Observable<any> {
    return this._HTTP.post<any>(environment.baseUrl8086 + 'business-cycle/cycle-definition', data);
  }
  ...
  AddCycleCreation(data): Observable<any> {
    return this._HTTP.post<any>(environment.baseUrl8086 + 'business-cycle', data);
  }
  ...
  // EdittoDate( businessCycleDefinitionId: number, BusinessYear: string, data: any ): Observable<any> {
  ...
  EdittoDate(businessCycleDefinitionId, BusinessYear): Observable<any> {
    return this._HTTP.put<any>(environment.baseUrl8086 + 'business-cycle/update/' + businessCycleDefinitionId + '/' + BusinessYear, '');
  }
  ...
  getAllHeadCreation() {
    ...
    return this._HTTP.get(this.url1 + 'payrollhead-master/global-getAll')
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  getAllActivePayrollHeadGroup() {
    return this._HTTP.get(this.url1 + 'payrollhead-attribute-mapping/getGlobal')
      .pipe(map((res: any) => {
        return res;
      }));
  ...
  GetHeadCreationById(id: any) {
    ...
    return this._HTTP.get(this.url1 + 'payrollhead-master/global-get/' + id)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  AddHeadCreation(data: SaveHeadCreation): Observable<number | {}> {
    ...
    return this._HTTP.post(this.url1 + 'payrollhead-master/global-add', data)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  getAllPayrollHeadGroupAtGlobal() {
    return this._HTTP.get(this.url1 + 'headGroup/getAllGlobalHeadGroup')
      .pipe(map((res: any) => {
        return res;
      }));
  ...
  getAllPayrollHeadGroup() {
    ...
    return this._HTTP.get(this.url1 + 'headGroup')
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  DeletePayrollHeadGroupGlobal(id: number) {
    return this._HTTP.delete(this.url1 + 'headGroup/deleteGlobalHeadGroup/' + id)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  DeletePayrollHeadGroup(id: number) {
    return this._HTTP.delete(this.url1 + 'headGroup/delete/' + id)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  AddPayrollHeadGroupAtGroup(data: SavePHG): Observable<number | {}> {
    ...
    return this._HTTP.post(this.url1 + 'headGroup', data)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  AddPayrollHeadGroupAtGlobal(data: SavePHGGlobal): Observable<number | {}> {
    ...
    return this._HTTP.post(this.url1 + 'headGroup/global', data)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  UpdatePayrollHeadGroupAtGlobal(id: number, data: SavePHGGlobal): Observable<number | {}> {
    ...
    return this._HTTP.put(this.url1 + 'headGroup/updateGlobalHeadGroupById/' + id, data)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  getPHGByIdGlobal(id: number) {
    return this._HTTP.get(this.url1 + 'headGroup/getGlobalPHGByIdWithMoon/' + id)
      .pipe(map((res: any) => {
        return res;
      }));
  ...
  GetPHGById(id: number) {
    ...
    return this._HTTP.get(this.url1 + 'headGroup/getPHGById/' + id)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  UpdatePHGById(id: number, data: SavePHG): Observable<number | {}> {
    ...
    return this._HTTP.put(this.url1 + 'headGroup/updateById/' + id, data)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  GetHeadListByPHGname(PHGname: string) {//: Observable<saveBusinessYear | {}> {
    ...
    return this._HTTP.get(this.url1 + 'headGroup/getPHGByName/' + PHGname)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  AddAttributeAssignment(data: UpdateflagCycleCreation): Observable<number | {}> {
    ...
    return this._HTTP.post(this.url1 + 'payrollhead-attribute-mapping', data)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  GetAttributeOptionListByHeadGroupId(HeadGroupId: number) {//: Observable<saveBusinessYear | {}> {
    ...
    return this._HTTP.get(this.url1 + 'payrollhead-attribute-mapping/getAttributeMasterListByHeadGroupId/' + HeadGroupId)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  GetAttributeOptionListByHeadGroupIdGetById(HeadGroupId: number) {
    ...
    return this._HTTP.get(this.url1 + 'payrollhead-attribute-mapping/getByHeadGroupId/' + HeadGroupId)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  getFromulaForFormulaMaster() {
    ...
    return this._HTTP.get(this.url1 + 'formula-master')
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  getSDMFormula() {
    ...
    return this._HTTP.get(this.url1 + 'companySDMForm')
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  UpdateattributeListById(data: UpdateflagCycleCreation): Observable<number | {}> {
    ...
    return this._HTTP.put(this.url1 + 'payrollhead-attribute-mapping', data)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  getByPayrollHeadGroupIdAllRecords(HeadGroupId: number) {
    ...
    return this._HTTP.get(this.url1 + 'payrollhead-attribute-mapping/getAllInfoByHeadGroupIdAsPerDepAttribute/' + HeadGroupId)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  GetHeadGroupByGetGlobalPHGByName(attributeGroupName: any) {
    return this._HTTP.get(this.url1 + 'attribute-group/global-getByGroupNameWithDepAtt/' + attributeGroupName)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  GetHeadGroupByGetGlobalPHGByNameWithHeadId(attributeGroupName: any, headGroupId: any) {
    return this._HTTP.get(this.url1 + 'attribute-group/global-getByGroupNameWithDependentAttributeWithHeadGruopId/' + attributeGroupName + '/' + headGroupId)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  addPHGAttributeDependency(data: any) {
    ...
    return this._HTTP.post(this.url1 + 'PayrollHeadGroup-AttributeDependency', data)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  getAttributeGroupByGroupDefId(id: number) {
    ...
    return this._HTTP.get(this.url1 + 'attribute-group/getAttributeGroupByAttGroupDefId/' + id)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  getGlobalAttribute2New(id1: number, id2: number) {
    ...
    return this._HTTP.get(this.url1 + 'attribute-group/getAttributeGroupByAttGroupDefId/' + id1 + '/' + id2)
      .pipe(map((res: any) => {
        return res;
      }));
  ...
  getGlobalAttribut33New(id1: number, id2: number, id3: number) {
    ...
    return this._HTTP.get(this.url1 + 'attribute-group/getAttributeGroupByAttGroupDefId/' + id1 + '/' + id2 + '/' + id3)
      .pipe(map((res: any) => {
        return res;
      }));
  ...
  getGlobalDependentAttributeNew(id1: number, id2: number, id3: number, id4: number) {
    ...
    return this._HTTP.get(this.url1 + 'attribute-group/getAttributeGroupByAttGroupDefId/' + id1 + '/' + id2 + '/' + id3 + '/' + id4)
      .pipe(map((res: any) => {
        return res;
      }));
  ...
  updateAttributeDependncyById(data: any) {
    ...
    return this._HTTP.put(this.url1 + 'PayrollHeadGroup-AttributeDependency', data)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  getHeadNatureByNatureGroup() {
    ...
    return this._HTTP.get(this.url1 + 'payrollhead-master/global-getByNatureGroup')
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  getGlobalAttribute2(id: number) {
    ...
    return this._HTTP.get(this.url1 + 'payrollhead-attribute-master/getAllActiveGlobalAttributeTwo/' + id)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  getGlobalAttribute3(id1: number, id2: number) {
    ...
    return this._HTTP.get(this.url1 + 'payrollhead-attribute-master/getAllActiveGlobalAttributeThree/' + id1 + '/' + id2)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  getGlobalAttributeById(id: number) {
    ...
    return this._HTTP.get(this.url1 + 'getGlobalAttributeMasterById/' + id)
      .pipe(map((res: any) => {
        return res;
      }));
  }
  ...
  getAllActivePHGAtrributeDep() {
    return this._HTTP.get(this.url1 + 'PayrollHeadGroup-AttributeDependency')
      .pipe(map((res: any) => {
        return res;
      }));
  ...
  softDeletePayrollHeadGroupAttributeDependency(id: number) {
    return this._HTTP.delete(this.url1 + 'PayrollHeadGroup-AttributeDependency/' + id)
      .pipe(map((res: any) => {
        return res;
      }));
  }
