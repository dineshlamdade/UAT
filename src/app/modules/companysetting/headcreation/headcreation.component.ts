...
import { headcreation } from './headcreation.service';
...
@Component({
  selector: 'app-headcreation',
  templateUrl: './headcreation.component.html',
  styleUrls: ['./headcreation.component.scss'],
...
export class HeadcreationComponent implements OnInit {
  ...
  constructor(
    ...
    private headCreationService: headcreation,
