...
import { attributecreation } from './attributecreation.service';
...
@Component({
  selector: 'app-attributecreation',
  templateUrl: './attributecreation.component.html',
  styleUrls: ['./attributecreation.component.scss'],
...
export class AttributecreationComponent implements OnInit {
  ...
  // Name:string;
   ...
   constructor(
    ...
    private attributeCreationService: attributecreation,
