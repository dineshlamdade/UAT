...
//Save PHG
  ...
  savePHG() {
    ...
    selectedCompanyGroupCodes.forEach((element) => {
      ...
      this.allGroupListGetEDList.push(element.code);
    });
    console.log("allGroupListGetEDList",this.allGroupListGetEDList)
  ...
  getListOfAllEDHeads() {
    this.payRollService.getAllEDHeadsGroup().subscribe((res) => {
      console.log('getAllEDHeadsGroup', res);
      let abc =  this. groupDescription
      this.listOfAssignEDHeadsList = res.data.results;
      console.log('getAllEDHeadsGroup', this.listOfAssignEDHeadsList);
      console.log("allGroupListByPostTime", this.allGroupListByPostTime);
      console.log("groupDescription", abc);
...
//Save ED
  ...
  saveED() {
    // const selectedCompanyGroupCodes = this.formED.get('companyGroupCode').value;
    // console.log('selectedCompanyGroupCodes' + selectedCompanyGroupCodes);
    // selectedCompanyGroupCodes.forEach((element) => {
    //   this.allGroupListByPostTime.push(element.code);
    // });
    ...
    //   console.log("allGroupList",this.allGroupList);
      ...
      //    const data = {
      //   headGroupDefinitions : this.targetProductsEDListBeforeSave,
      //   groupCode : this.allGroupListByPostTime,
      //   // groupCode : this.pHGForm.get('companyGroupCode').value,
      //   groupDescription : this.pHGForm.get('companyGroupName').value
      //  }
       ...
       const data = {
        ...
        groupCode : this.allGroupListGetEDList,
        // groupCode : this.pHGForm.get('companyGroupCode').value,
        groupDescription : this.formED.get('companyGroupName').value
       }
