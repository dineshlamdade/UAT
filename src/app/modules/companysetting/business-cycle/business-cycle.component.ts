...
/////////////////bharati
//mport { saveBusinessYear, serviceDetails, saveCycleDefinition, saveCycleCreation, getchapter, flagCycleCreation, UpdateflagCycleCreation } from './payroll.model';
...
export class BusinessCycleComponent implements OnInit {
  ...
  constructor(
    ...
    private payrollService: CompanySettingsService,
