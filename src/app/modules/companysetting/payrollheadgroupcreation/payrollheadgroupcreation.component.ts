...
import { payrollheadgroupcreation } from './payrollheadgroupcreation.service';
...
@Component({
  selector: 'app-payrollheadgroupcreation',
  templateUrl: './payrollheadgroupcreation.component.html',
  styleUrls: ['./payrollheadgroupcreation.component.scss'],
...
export class PayrollheadgroupcreationComponent implements OnInit {
  ...
  constructor(
    ...
    private payrollheadgroupcreationService: payrollheadgroupcreation,
  ) { }
