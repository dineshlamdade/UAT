...
exports.LeftadminmenuComponent = void 0;
var core_1 = require("@angular/core");
var app_component_1 = require("src/app/app.component");
var LeftadminmenuComponent = /** @class */ (function () {
    function LeftadminmenuComponent(router, app) {
        this.router = router;
        this.app = app;
    ...
    LeftadminmenuComponent.prototype.ngOnInit = function () {
    };
    LeftadminmenuComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        var pThis = this;
        setTimeout(function () {
    ...
    LeftadminmenuComponent.prototype.onTab = function (number) {
        this.chatTab = false;
    ...
    LeftadminmenuComponent.prototype.onFontStyle = function (type) {
    ...
    LeftadminmenuComponent.prototype.onSubMenuIcon = function (type) {
        debugger;
    ...
    LeftadminmenuComponent.prototype.toggleUserMenu = function () {
    ...
    LeftadminmenuComponent.prototype.toggleSettingMenu = function () {
    ...
    LeftadminmenuComponent.prototype.onGeneralSetting = function (type, e) {
        var body = document.getElementsByTagName('body')[0];
        if (type == 1) {
    ...
    LeftadminmenuComponent.prototype.toggleMenu = function () {
        var body = document.getElementsByTagName('body')[0];
    ...
    LeftadminmenuComponent.prototype.cToggoleMenu = function () {
        var body = document.getElementsByTagName('body')[0].classList.remove("offcanvas-active");
        document.getElementsByClassName('overlay')[0].classList.toggle("open");
    };
    LeftadminmenuComponent.prototype.CardRemoveStatics = function () {
        this.staticscard = false;
    };
    LeftadminmenuComponent.prototype.CardRemoveFriends = function () {
        this.friendscard = false;
    };
    LeftadminmenuComponent = __decorate([
        core_1.Component({
            selector: 'app-leftadminmenu',
            templateUrl: './leftadminmenu.html'
        }),
        __param(1, core_1.Inject(app_component_1.AppComponent))
    ], LeftadminmenuComponent);
    return LeftadminmenuComponent;
}());
exports.LeftadminmenuComponent = LeftadminmenuComponent;
