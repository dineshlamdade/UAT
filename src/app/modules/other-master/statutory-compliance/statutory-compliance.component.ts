...
export class StatutoryComplianceComponent implements OnInit {
 ...
 public groupNameScaleNameStartDateObject:any[] = [];
  constructor(private formBuilder: FormBuilder, private datePipe: DatePipe, private statuatoryComplianceService:StatuatoryComplianceService, private complianceHeadService:ComplianceHeadService) {
    ...
    if(this.isEditMode == true){
      ...
      this.statuatoryComplianceService.putComplianceInstituionMaster(data).subscribe(res => {
        ...
        if (res.data.results.length > 0) {
          ...
          this.sweetalertMasterSuccess('Statutory Compliance Updated Successfully.', '');
      ...
      this.statuatoryComplianceService.postComplianceInstituionMaster(data).subscribe(res => {
        ...
        if (res.data.results.length > 0) {
          console.log('data is updated');
          this.sweetalertMasterSuccess('Statutory Compliance Saved Successfully.', '');
          this.saveFormValidation();
          this.form.reset();
          this.isSaveAndReset = true;
          this.showButtonSaveAndReset = true;
  ...
  editMaster(i: number) {
    ...
    this.form.reset();
      ...
      this.form.patchValue({
        ...
        let a = this.summaryHtmlDataList[i].telephoneNumber.split(' ');
