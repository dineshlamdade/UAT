...
@Component({
  selector: 'app-investment-treatment-of-specified-diseases-master-approval',
  templateUrl: './investment-treatment-of-specified-diseases-master-approval.component.html',
  styleUrls: ['./investment-treatment-of-specified-diseases-master-approval.component.scss']
})
export class InvestmentTreatmentOfSpecifiedDiseasesMasterApprovalComponent implements OnInit {
