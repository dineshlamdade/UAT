...
@Component({
  selector: 'app-investment-handicapped-dependenttransaction-approval',
  templateUrl: './investment-handicapped-dependenttransaction-approval.component.html',
  styleUrls: ['./investment-handicapped-dependenttransaction-approval.component.scss']
})
export class InvestmentHandicappedDependenttransactionApprovalComponent implements OnInit {
  ...
  openMasterDetailInPopUp(masterDetailtemplate: TemplateRef<any>, masterPSID:any) {
    this.investmentHandicappeddependentmasterApprovalService
  ...
  getTransactionInfoByPSID(psid: any): void {
    this.investmentHandicappedDependenttransactionApprovalService
