...
@Component({
  selector: 'app-investment-mediclaim80-dmaster-approval',
  templateUrl: './investment-mediclaim80-dmaster-approval.component.html',
  styleUrls: ['./investment-mediclaim80-dmaster-approval.component.scss']
})
export class InvestmentMediclaim80DMasterApprovalComponent implements OnInit {
