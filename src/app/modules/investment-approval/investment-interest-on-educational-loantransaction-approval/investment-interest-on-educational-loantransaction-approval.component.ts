...
@Component({
  ...
  templateUrl: './investment-interest-on-educational-loantransaction-approval.component.html',
  styleUrls: ['./investment-interest-on-educational-loantransaction-approval.component.scss']
})
export class InvestmentInterestOnEducationalLoantransactionApprovalComponent implements OnInit {
  ...
  getTransactionInfoByPSID(psid: any): void {
    this.investmentInterestOnEducationalLoantransactionApprovalService
