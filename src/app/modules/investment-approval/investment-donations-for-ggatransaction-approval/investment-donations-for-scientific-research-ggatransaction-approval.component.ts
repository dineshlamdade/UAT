...
@Component({
  ...
  templateUrl: './investment-donations-for-scientific-research-ggatransaction-approval.component.html',
  styleUrls: ['./investment-donations-for-scientific-research-ggatransaction-approval.component.scss']
})
