...
import { InvestmentInterestOnLoanForPurchaseOfElectricVehicleMasterApprovalService } from '../investment-interest-on-loan-for-purchase-of-electric-vehicle-master-approval/investment-interest-on-loan-for-purchase-of-electric-vehicle-master-approval.service';
import { MyInvestmentsService } from '../../my-Investments/my-Investments.service';

@Component({
  selector: 'app-investment-interest-on-loan-for-purchase-of-electric-vehicletransaction-approval',
  templateUrl: './investment-interest-on-loan-for-purchase-of-electric-vehicletransaction-approval.component.html',
  styleUrls: ['./investment-interest-on-loan-for-purchase-of-electric-vehicletransaction-approval.component.scss']
})
export class InvestmentInterestOnLoanForPurchaseOfElectricVehicletransactionApprovalComponent implements OnInit {
  ...
  constructor(
    ...
    private investmentInterestOnLoanForPurchaseOfElectricVehicletransactionApprovalService: InvestmentInterestOnLoanForPurchaseOfElectricVehicletransactionApprovalService,
  ...
  getTransactionInfoByPSID(psid: any): void {
    this.investmentInterestOnLoanForPurchaseOfElectricVehicletransactionApprovalService
...
public onChangeDocumentRemark(docDetail, event) {
  ...
  debugger
      ...
      this.investmentInterestOnLoanForPurchaseOfElectricVehicletransactionApprovalService.getelectricVehicleLoanTransactionApprovalRemarkList(
        transactionId,
      ).subscribe((res) => {
