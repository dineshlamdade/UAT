...
import { InvestmentMediclaim80DMasterApprovalService } from '../investment-mediclaim80-dmaster-approval/investment-mediclaim80-dmaster-approval.service';

@Component({
  selector: 'app-investment-mediclaim80-dtransaction-approval',
  templateUrl: './investment-mediclaim80-dtransaction-approval.component.html',
  styleUrls: ['./investment-mediclaim80-dtransaction-approval.component.scss']
})
export class InvestmentMediclaim80DtransactionApprovalComponent implements OnInit {
  ...
  constructor(
    ...
    private investmentMediclaim80DMasterApprovalService: InvestmentMediclaim80DMasterApprovalService,
    private investmentMediclaim80DtransactionApprovalService: InvestmentMediclaim80DtransactionApprovalService,
  ...
  openMasterDetailInPopUp(masterDetailtemplate: TemplateRef<any>, masterPSID:any) {
    this.investmentMediclaim80DMasterApprovalService
  ...
  getTransactionInfoByPSID(psid: any): void {
    this.investmentMediclaim80DtransactionApprovalService
