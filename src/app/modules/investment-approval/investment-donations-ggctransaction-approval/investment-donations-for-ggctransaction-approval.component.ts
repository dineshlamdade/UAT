...
@Component({
  ...
  templateUrl: './investment-donations-for-registered-political-party-electoral-trust-sec80-ggctransaction-approval.component.html',
  styleUrls: ['./investment-donations-for-registered-political-party-electoral-trust-sec80-ggctransaction-approval.component.scss']
})
