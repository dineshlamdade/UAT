...
import { InvestmentTreatmentOfSpecifiedDiseasesMasterApprovalService } from '../investment-treatment-of-specified-diseases-master-approval/investment-treatment-of-specified-diseases-master-approval.service';
...
@Component({
  selector: 'app-investment-treatment-of-specified-diseasestransaction-approval',
  templateUrl: './investment-treatment-of-specified-diseasestransaction-approval.component.html',
  styleUrls: ['./investment-treatment-of-specified-diseasestransaction-approval.component.scss']
})
export class InvestmentTreatmentOfSpecifiedDiseasestransactionApprovalComponent implements OnInit {
  ...
  constructor(
    ...
    private investmentTreatmentOfSpecifiedDiseasesMasterApprovalService: InvestmentTreatmentOfSpecifiedDiseasesMasterApprovalService,
    private investmentTreatmentOfSpecifiedDiseasestransactionApprovalService: InvestmentTreatmentOfSpecifiedDiseasestransactionApprovalService,
  ...
  openMasterDetailInPopUp(masterDetailtemplate: TemplateRef<any>, masterPSID:any) {
    this.investmentTreatmentOfSpecifiedDiseasesMasterApprovalService
  ...
  getTransactionInfoByPSID(psid: any): void {
    this.investmentTreatmentOfSpecifiedDiseasestransactionApprovalService
