...
import { InvestmentIntereston80TTATTBMasterApprovalService } from '../investment-intereston80-tta-ttb-master-approval/investment-intereston80-tta-ttb-master-approval.service';
import { MyInvestmentsService } from '../../my-Investments/my-Investments.service';

@Component({
  selector: 'app-investment-interest-on80-tta-ttb-transaction-approval',
  templateUrl: './investment-interest-on80-tta-ttb-transaction-approval.component.html',
  styleUrls: ['./investment-interest-on80-tta-ttb-transaction-approval.component.scss']
})
export class InvestmentInterestOn80TTATTBTransactionApprovalComponent implements OnInit {
  ...
  constructor(
    ...
    private investmentInterestOn80TTATTBTransactionApprovalService: InvestmentInterestOn80TTATTBTransactionApprovalService,
  ...
  getTransactionInfoByPSID(psid: any): void {
    this.investmentInterestOn80TTATTBTransactionApprovalService
...
debugger
    ...
    this.investmentInterestOn80TTATTBTransactionApprovalService.getinterestOnDeposit80TTA80TTBTransactionApprovalRemarkList(
      transactionId,
    ).subscribe((res) => {
