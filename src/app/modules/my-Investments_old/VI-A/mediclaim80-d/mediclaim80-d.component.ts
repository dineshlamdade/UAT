...
@Component({
  selector: 'app-mediclaim80-d',
  templateUrl: './mediclaim80-d.component.html',
  styleUrls: ['./mediclaim80-d.component.scss']
})
export class Mediclaim80DComponent implements OnInit {
