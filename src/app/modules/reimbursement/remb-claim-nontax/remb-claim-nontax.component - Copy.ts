...
@Component({
  selector: 'app-remb-claim-nontax',
  templateUrl: './remb-claim-nontax.component.html',
  styleUrls: ['./remb-claim-nontax.component.scss']
})
export class RembClaimNontaxComponent implements OnInit {
  ...
  constructor(
    public service: RembClaimNontaxService,
