import { ChangeDetectorRef, Component, IterableDiffers, OnInit, TemplateRef  } from '@angular/core';
...
export class WorkflowMasterComponent implements OnInit {
  ...
  public reassignedValidation(template: TemplateRef<any>, index): void {
    this.approverSequence = index;
  ...
  public updateReassignMethodDetails(item: Array<any>): void {
